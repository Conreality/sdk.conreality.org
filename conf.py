...
sys.path.append(os.path.abspath('.imports/conreality.py/src'))
...
version = u'2017-06-26'
# The full version, including alpha/beta/rc tags.
release = u'2017-06-26'
...
exclude_patterns = ['.build', '.extensions', '.imports', '.templates', '.themes', 'README.rst']
